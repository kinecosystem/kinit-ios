...
internal enum L10n {
  ...
  internal enum AppDiscovery {
    internal enum Footer {
      ...
      internal enum Title {
        ...
        internal static let discovery = L10n.tr("Localizable", "AppDiscovery.Footer.Title.Discovery")
        /// Learn more about sending Kin
        internal static let sendAvailable = L10n.tr("Localizable", "AppDiscovery.Footer.Title.SendAvailable")
      }
    }
  ...
  internal enum OneWallet {
    internal enum ConnectScreen {
      ...
      /// Please give Kinit permission to receive your Kin account information (i.e., your public address and user ID) to approve future transactions in %@.
      internal static func explanation(_ p1: String) -> String {
        return L10n.tr("Localizable", "OneWallet.ConnectScreen.Explanation", p1)
      }
